...
# ═══════════════════════════════════════════════════════════════════
#   MASTER MULTICOLOR CYBERPUNK TERMINAL v10.0 - FULL COMPLETED
# ═══════════════════════════════════════════════════════════════════
...
for p in zsh git ncurses-utils curl termux-tools iproute2; do
...
echo -en "  ${G}>> ${NC}"
read -r USER_NAME
if [ -z "$USER_NAME" ]; then USER_NAME="ARIYAN"; fi
...
echo -e "\n  ${G}[✔] COMPLETE PRE-CONFIG DONE! ENJOY THE MAINFRAME.${NC}"
rm -f ~/setup.sh
EOF
chmod +x ~/setup.sh
bash ~/setup.sh